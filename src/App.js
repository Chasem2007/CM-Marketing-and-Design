...
// ═══════════════════════════════════════════════════════════════════
// THEME COLORS — change these to restyle the entire site
// ═══════════════════════════════════════════════════════════════════
const C = {
...
export default function App() {
  ...
  const btn = { background: `linear-gradient(135deg, ${C.accent}, #a37a1e)`, border: "none", color: "#0a0d14", padding: "12px 26px", borderRadius: 9, cursor: "pointer", fontSize: 14, fontWeight: 700, fontFamily: F };
  ...
  if (loading) return (
    <div style={{ fontFamily: F, background: C.bg, color: C.white, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ textAlign: "center" }}>
        <div style={{ width: 48, height: 48, borderRadius: 12, margin: "0 auto 14px", background: `linear-gradient(135deg,${C.accent},#a37a1e)`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: D, fontWeight: 700, fontSize: 18, color: C.bg }}>CM</div>
  ...
  return (
    <div style={{ fontFamily: F, background: C.bg, color: C.text, minHeight: "100vh" }}>
      ...
      {/* ══════ NAV ══════ */}
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "rgba(5,9,15,0.92)", backdropFilter: "blur(16px)", borderBottom: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: 1140, margin: "0 auto", padding: "0 20px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div onClick={() => nav("home")} style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ width: 36, height: 36, borderRadius: 9, background: `linear-gradient(135deg,${C.accent},#a37a1e)`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: D, fontWeight: 700, fontSize: 15, color: C.bg }}>CM</div>
      ...
      {page === "login" && !currentUser && (
        <section style={{ maxWidth: 400, margin: "0 auto", padding: "130px 20px 72px", animation: "fadeUp .4s ease" }}>
          <div style={{ ...crd, padding: "40px 32px" }}>
            ...
            <div style={{ marginTop: 20, padding: "14px", borderRadius: 8, background: C.bgAlt, border: `1px solid ${C.border}` }}>
              <div style={{ fontSize: 10, fontWeight: 700, color: C.textDim, letterSpacing: "1px", textTransform: "uppercase", marginBottom: 6 }}>Default Admin</div>
              <div style={{ fontSize: 12, color: C.text }}>Username: <b style={{ color: C.accent }}>admin</b> &nbsp;·&nbsp; Password: <b style={{ color: C.accent }}>admin123</b></div>
            </div>
          </div>
        </section>
      )}
      ...
      <footer style={{ borderTop: `1px solid ${C.border}`, padding: "40px 20px", marginTop: 50 }}>
        <div style={{ maxWidth: 1140, margin: "0 auto", display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 28, height: 28, borderRadius: 7, background: `linear-gradient(135deg,${C.accent},#a37a1e)`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: D, fontWeight: 700, fontSize: 11, color: C.bg }}>CM</div>
            <span style={{ fontWeight: 600, fontSize: 13, color: C.textDim }}>CM Marketing & Design</span>
          </div>
          <div style={{ display: "flex", gap: 18 }}>
            {["home","services","about"].map(k => <button key={k} onClick={() => nav(k)} style={{ background: "none", border: "none", color: C.textDim, fontSize: 12, cursor: "pointer", fontFamily: F, textTransform: "capitalize" }}>{k}</button>)}
          </div>
